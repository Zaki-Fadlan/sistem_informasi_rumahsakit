...
class m250413_092330_seedprovinsi extends CDbMigration
{
	public function up()
	{
	$this->insertMultiple('tbl_provinsi', [
		['id_provinsi' => 11, 'nama_provinsi' => 'Aceh (NAD)'],
		...
		['id_provinsi' => 52, 'nama_provinsi' => 'Nusa Tenggara Barat (NTB)'],
		['id_provinsi' => 53, 'nama_provinsi' => 'Nusa Tenggara Timur (NTT)'],
		...
		['id_provinsi' => 93, 'nama_provinsi' => 'Papua Selatan'],
		['id_provinsi' => 94, 'nama_provinsi' => 'Papua Tengah'],
		['id_provinsi' => 95, 'nama_provinsi' => 'Papua Pegunungan'],
		['id_provinsi' => 96, 'nama_provinsi' => 'Papua Barat Daya'],
	]);
	...
	{
		echo "m250412_063126_seedprovinsi does not support migration down.\n";
		return false;
	}
