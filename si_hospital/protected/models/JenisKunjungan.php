...
/**
 * This is the model class for table "tbl_jenis_kunjungan".
 *
 * The followings are the available columns in table 'tbl_jenis_kunjungan':
...
class JenisKunjungan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_jenis_kunjungan, nama_jenis', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'Kunjungan' => array(self::HAS_MANY, 'Kunjungan', 'id_jenis_kunjungan'),
		);
	}
