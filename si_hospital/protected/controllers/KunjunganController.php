...
class KunjunganController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',
				...
				'expression'=>'Yii::app()->user->checkAccess("kelolaPasien") || Yii::app()->user->checkAccess("kelolaKunjungan")',
			),
	 ...
	 */
	public function actionCreate($id_pasien = null)
	{
		$model = new Kunjungan;
		...
		if (isset($_POST['Kunjungan'])) {
			...
			$model->id_petugas = Yii::app()->user->id;
